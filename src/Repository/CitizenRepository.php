 ...
 */
class CitizenRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    /**
     * Mise à jour du chanmp discr de la table Citizen.
     * Utile pour faire évoluer un citoyen en Moderator, Admin ou SuperAdmin
     *
